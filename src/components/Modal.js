              ...
              <div className="columns modal-wrapper">
                <div className="column is-12-mobile is-11-tablet is-10-desktop modal-inner">
                  <div className="columns is-centered">
                    ...
                    <div className="column is-12-mobile is-12-tablet is-11-desktop features--left features--left-modal" style={{ backgroundImage: `url( ${ data.large_image.childImageSharp.fluid.src })` }}>
